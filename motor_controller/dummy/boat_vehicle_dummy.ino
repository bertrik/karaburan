...
const int motorAPin1 = 6;//green led//pin 9 on boat; // Timer1 output A
const int motorAPin2 = 5;//red led//pin 10 on boat; // Timer1 output B
const int motorBPin1 = 10;//led//pin 3 on boat;
const int motorBPin2 = 9;//led//pin 11 on boat;
